...
Singleton {
    ...
    property string nfSymbol: ethernet ? "󰌗" : (Network.networkName.length > 0 && Network.networkName != "lo") ? (Network.networkStrength > 80 ? "󰤨" : Network.networkStrength > 60 ? "󰤥" : Network.networkStrength > 40 ? "󰤢" : Network.networkStrength > 20 ? "󰤟" : "󰤯") : "󰤭"
